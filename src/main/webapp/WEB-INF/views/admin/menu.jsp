	...
	<div class="left-nav clearfix">
		...
		<div class="left-secondary-nav tab-content" >
			<div class="tab-pane active dailyreport" id="dailyreport">
				...
				<c:if test="${sessionScope.adminuser.role1=='yes'}">
					<li><a href="${pageContext.request.contextPath}/admin/seller/index"><i class="icon-pencil"></i> 卖家管理</a></li>
				</c:if>
					...
					<c:if test="${sessionScope.adminuser.role2=='yes'}">
						<li><a href="${pageContext.request.contextPath}/admin/category/index"><i class="icon-upload"></i>商品 分类管理 </a></li>
					</c:if>
